...
###############################################################################
# remember to set the working directory for your project.
#setwd("projects")

###############################################################################
# download Human Activity using Smartphone data.
...
smartPhoneData = "./UCI HAR Dataset"; dir(smartPhoneData)
...
# read in the descriptive activity labels
